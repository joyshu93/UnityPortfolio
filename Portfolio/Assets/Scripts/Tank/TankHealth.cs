...
{ 
    ...
    public Slider m_FirstPersonSlider;
    public Slider m_ThirdPersonSlider;
    public Image m_FirstPersonFillImage;
    ...
    {
        m_FirstPersonSlider.value = m_CurrentHealth;
        m_ThirdPersonSlider.value = m_CurrentHealth;

        m_FirstPersonFillImage.color = Color.Lerp(m_ZeroHealthColor, m_FullHealthColor, m_CurrentHealth / m_StartingHealth);
